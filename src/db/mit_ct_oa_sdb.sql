...
--
-- Host: localhost:3306
-- Generation Time: Jan 27, 2021 at 01:38 PM
...
CREATE TABLE `course_artimat` (
  ...
  `po5` int(11) DEFAULT NULL,
  `po6` int(11) DEFAULT NULL,
  `po7` int(11) DEFAULT NULL,
  `po8` int(11) DEFAULT NULL,
  `po9` int(11) DEFAULT NULL,
  `po10` int(11) DEFAULT NULL,
  `po11` int(11) DEFAULT NULL,
  `po12` int(11) DEFAULT NULL,
...
CREATE TABLE `person` (
  ...
  `Aadhar_Card` bigint(20) DEFAULT NULL,
...
CREATE TABLE `student_endsemmarks` (
  ...
  `Register_No` int(11) NOT NULL,
  `Semester` int(11) NOT NULL,
  `Course_Code` varchar(15) CHARACTER SET utf8 DEFAULT NULL,
...
CREATE TABLE `student_family_details` (
  ...
  `Parents_Annual_Income` bigint(20) DEFAULT NULL,
...
--
ALTER TABLE `course_attendance`
  MODIFY `cattend_id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `course_evaluation`
  MODIFY `caval_id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `credentials`
  MODIFY `Credentials_ID` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `student_higherstudies`
  MODIFY `HigherStudies_ID` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `person`
  ...
  ADD CONSTRAINT `Designation_FK` FOREIGN KEY (`Designation`) REFERENCES `person_reference_table` (`Ref_Code`),
  ...
  ADD CONSTRAINT `Person_ID_ref_FK` FOREIGN KEY (`Person_ID`) REFERENCES `user_info` (`username`),
...
ALTER TABLE `student`
  ...
  ADD CONSTRAINT `User_ID_Ref` FOREIGN KEY (`Register_No`) REFERENCES `user_info` (`username`),
